defmodule Estoreapp.ReviewsTest do
  ...
  describe "reviews" do
    ...
    @valid_attrs %{product_id: 42, review: "some review", user: "some user"}
    @update_attrs %{product_id: 43, review: "some updated review", user: "some updated user"}
