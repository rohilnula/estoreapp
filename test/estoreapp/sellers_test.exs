defmodule Estoreapp.SellersTest do
  ...
  describe "sellers" do
    ...
    @valid_attrs %{email: "some email", money: 120.5, name: "some name", password_hash: "some password_hash"}
    @update_attrs %{email: "some updated email", money: 456.7, name: "some updated name", password_hash: "some updated password_hash"}
