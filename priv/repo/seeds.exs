...
Repo.insert!(%Purchase{price: 10.0, product_name: "TV", quantity: 10, user_name: "AliceW"})
Repo.insert!(%Purchase{price: 10.0, product_name: "TV", quantity: 10, user_name: "BobbyW"})
Repo.insert!(%Purchase{price: 10.0, product_name: "TV", quantity: 10, user_name: "BobbyW"})
Repo.insert!(%Purchase{price: 10.0, product_name: "TV", quantity: 10, user_name: "AliceW"})
